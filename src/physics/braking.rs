...
pub(crate) fn calculate_brake_force(mass_distribution: MassDistribution, mu_static_friction: f64, g_acceleration: f64) -> f64 {
...
mod tests {
    ...
    fn test_calculate_brake_force() {
        ...
        let brake_force = calculate_brake_force(car_model.mass_distribution, tyre_model.mu_static_friction, environment_model.g_acceleration);
