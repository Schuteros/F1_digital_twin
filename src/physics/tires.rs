...
#[cfg(test)]
mod tests {
    use crate::physics::tires::{
        calculate_current_tire_friction, calculate_force_static_friction,
    ...
    fn test_breakaway_tire_friction_calculations() {
        ...
        let tire_breakaway_friction: f64 =
    ...
    fn test_current_tire_friction_calculations() {
        ...
        let mut current_tire_friction: f64 = calculate_current_tire_friction(
            normal_force,
            mu_rolling_friction,
            mu_breakaway_friction,
            speed,
        );
        ...
        current_tire_friction = calculate_current_tire_friction(
            normal_force,
            mu_rolling_friction,
            mu_breakaway_friction,
            speed,
    ...
    fn test_static_tire_friction_calculations() {
        ...
        let tire_static_friction: f64 =
            calculate_force_static_friction(normal_force, mu_static_friction);
